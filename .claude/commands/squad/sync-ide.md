...
/squad:sync-ide              — gera para todas IDEs habilitadas em project.yaml
/squad:sync-ide cursor       — gera apenas para Cursor (.cursorrules)
/squad:sync-ide windsurf     — gera apenas para Windsurf (.windsurfrules)
/squad:sync-ide copilot      — gera apenas para GitHub Copilot (.github/copilot-instructions.md)
