...
3. Verifique se `squads/{nome}/squad.yaml` existe
   - Se NAO: liste squads disponiveis com `/squad:list-squads` e pergunte qual usar
...
```
/squad:run-squad meu-saas "implementar sistema de notificacoes push"
/squad:run-squad data-pipeline "criar ETL para importar dados do CRM"
/squad:run-squad --auto landing-pages "criar landing page para produto X"
/squad:run-squad --dry-run meu-saas "refatorar modulo de pagamentos"
```
