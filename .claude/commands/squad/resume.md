...
Le o handoff salvo por `/squad:pause` e restaura todo o contexto necessario para continuar o trabalho. Inclui: fase atual, progresso, decisoes tomadas e proximo passo.

## Quando usar

- Ao iniciar uma nova sessao de trabalho
- Apos ter usado `/squad:pause` anteriormente
