...
- Apos gerar planos (`/squad:plan-phase`)
- Antes de executar (`/squad:execute-phase`)
...
2. O GSD plan-checker sera invocado durante `/squad:plan-phase` automaticamente, mas pode ser chamado isoladamente para re-validacao.
