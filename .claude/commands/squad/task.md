...
/squad:task [template-name] [contexto adicional]
...
- `/squad:task dev-api-endpoint criar endpoint de upload` — Implementar endpoint
- `/squad:task qa-code-review src/lib/services/` — Revisar codigo de um diretorio
- `/squad:task db-migration adicionar tabela de notificacoes` — Criar migracao
- `/squad:task sec-owasp-audit` — Auditoria de seguranca completa
