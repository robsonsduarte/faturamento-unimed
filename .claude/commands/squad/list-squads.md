...
2. Se NAO existir:
   ...
   - Sugira: "Use `/squad:create-squad {nome}` para criar seu primeiro squad."
   - Encerre aqui
...
- Criar novo squad: `/squad:create-squad {nome}`
- Executar um squad: `/squad:run-squad {nome} "demanda"`
- Clonar mente de especialista: `/squad:clone-mind {nome}`
```
