    ...
    if (responseNodes.length > 0) {
      ...
      for (var i=0; i<itemNodes.length; i++) {
        ...
        if (nameNodes.length > 0 && valueNodes.length > 0) {
          ...
          /**
           * Framework alterado devido um problema, no qual se o valor setado fosse "" (Branco)
           * ocorria uma exception ao atribuir na variavel value, Com essa verificação 
           * é possivel setar um espaço em branco no lugar do "###" que é o caracter que foi espercificado 
           * como espaço em branco, para evitar a exception.  
           */
          if(value == "###"){
          	value = "";
          }          
...
Object.extend(Object.extend(Ajax.XmlToHtmlAutocompleter.prototype, Autocompleter.Base.prototype), {
  ...
  onComplete: function(request) {
    ...
    document.getElementById(this.divUpdate).style.width = 'auto';
  }
...
AjaxJspTag.Autocomplete.prototype = Object.extend(new AjaxJspTag.Base(), {
  ...
  initialize: function(url, options) {
    ...
    // create DIV
    new Insertion.After(this.options.source, '<div id="' + this.options.divElement + '" class="autocomplete"></div>');
