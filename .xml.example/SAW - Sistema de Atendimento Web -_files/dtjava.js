var dtjava = function() {
	...
	function L() {
		if (!aN) {
			try {
				var w = aa.getElementsByTagName("body")[0].appendChild(aa
						.createElement("div"));
	...
	function aA() {
		var bm = v(aa.getElementById) && v(aa.getElementsByTagName)
				&& v(aa.createElement);
		var be = navigator.userAgent.toLowerCase(), bi = navigator.platform
				.toLowerCase();
		var bp = bi ? /win/.test(bi) : /win/.test(be), a4 = bi ? /mac/.test(bi)
				: /mac/.test(be), bb = bi ? /linux/.test(bi) : /linux/.test(be), bg = /chrome/
				.test(be), d = !bg && /webkit/.test(be) ? parseFloat(be
				.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : false, bn = /opera/
				.test(be), a5 = null, w = null;
		var bh = false;
		try {
		...
		if (a4) {
			...
			w = u(bf) ? bf[0].replace("mac os x ", "").replace(/_/g, ".")
					: null
		}
		...
		if (typeof __dtjavaTestHook__ !== "undefined"
				&& __dtjavaTestHook__ != null && __dtjavaTestHook__.jre != null
			...
			for (var bf = 0; bf < bl.length; bf++) {
				...
				if (bj.indexOf("application/x-java-applet;version") != -1
						&& bj.indexOf("=") != -1) {
				...
				if (bj.indexOf("application/x-java-applet;deploy") != -1
						&& bj.indexOf("=") != -1) {
					a3 = bj.substring(bj.indexOf("=") + 1)
				}
				if (bj.indexOf("application/x-java-applet;javafx") != -1
						&& bj.indexOf("=") != -1) {
	...
	function ap() {
		if (typeof __dtjavaTestHook__ !== "undefined") {
			...
			jfx = null;
			deploy = null;
			if ((__dtjavaTestHook__ != null)
					&& (__dtjavaTestHook__.args != null)) {
		...
		if ((v(aa.readyState) && aa.readyState == "complete")
				|| (!v(aa.readyState) && (aa.getElementsByTagName("body")[0] || aa.body))) {
			L()
		}
		if (!aN) {
			if (v(aa.addEventListener)) {
				...
				if (v(aa.addEventListener)) {
					aa.addEventListener("onreadystatechange", function() {
						if (aa.readyState == "complete") {
							aa.removeEventListener("onreadystatechange",
					...
					aa.attachEvent("onreadystatechange", function() {
						if (aa.readyState == "complete") {
							aa.detachEvent("onreadystatechange",
									arguments.callee);
							L()
						}
					})
	...
	function Y(a2) {
		...
		if (x(a2)) {
			...
			var d = window.location.href.replace('/tiss', '');
	...
	function ab(a4, a3, ba, a5, a7) {
		...
		if (!ba.isUnsupportedPlatform() && !ba.isUnsupportedBrowser()) {
			if (at(ba) && v(a5.onInstallNeeded)) {
				...
				a5.onInstallNeeded(a4, a3, a5, ba.canAutoInstall(), ba
						.isRelaunchNeeded(), bc);
				return
			}
		}
	...
	function al(w) {
		...
		if (ad.ie) {
			...
			d.setAttribute("docbase", (u(aa.documentURI) ? aa.documentURI
					: aa.URL));
			d.type = "application/x-java-applet;version=1.7"
		}
	...
	var l = function(a6, bi) {
			...
			function bs() {
				...
				if (bz.length > 0) {
					...
					if (bv >= bt.length) {
						...
						while (bv < bt.length) {
							var bD = bt.charAt(bv);
							if ((bC == ay.Uninitialized || bC == ay.Alpha)
									&& by(bD) == true) {
								bC = ay.Alpha;
								bv++;
								bB += bD
							} else {
								if ((bC == ay.Uninitialized || bC == ay.Digits)
										&& bw(bD) == true) {
									...
									if ((bC == ay.Alpha || bC == ay.Identifier)
											&& bw(bD) == true
											&& by(bD) == false) {
										bC = ay.Identifier;
										bv++;
		...
		function bf() {
					...
					for (var bz = 0; bz < (a3 - 1); bz++) {
						if (bB.tokenID == ay.Dot) {
							...
							if (bB.tokenID == ay.Star
									...
									|| bB.tokenID == ay.End
									|| bB.tokenID == ay.Minus
									|| bB.tokenID == ay.Underbar
									|| bB.tokenID == ay.Identifier
									|| (bB.tokenID == ay.Alpha && bB.token == "u")) {
								break
							} else {
								by = null;
								break
			...
			function bs(bz, bA) {
				var by = false;
				if (bz.length == 1 && parseInt(bz[0]) <= 8
						&& bA.tokenID == ay.Identifier && bA.token.length > 0
						&& bA.token.charAt(0) == "u") {
					by = true
				}
				return by
		...
		function a2(bs, br) {
			...
			if ((bs.major != null)
					&& (br.major != null)
					&& a7(bs.major, br.major)
					&& a7(bs.minor, br.minor)
					&& a7(bs.security, br.security)
					&& a7(bs.patch, br.patch)
					&& (bs.old == br.old)
					&& (bs.pre == br.pre)
					&& ((parseInt(bs.build) == parseInt(br.build)) || (bs.build == null && br.build == null))) {
				bq = true
			}
			return bq
		}
		function a4(bu, br) {
			...
			if (bu.old == true && bu.version.length == 0 && br.old == true) {
				...
				for (index = 0; index < bu.version.length
						&& index < br.version.length; index++) {
			...
			if (bv.old == true && bv.version.length == 0) {
				...
				if (bv.old == true && br.old == false) {
					...
					if (bv.major == 0) {
						...
						if ((bv.major != null)
								&& (br.major != null)
								&& ((parseInt(bv.build) == parseInt(br.build)) || (bv.build == null && br.build == null))) {
							for (var bt = 0; bt < bv.version.length; bt++) {
								...
								if (parseInt(bu) == parseInt(bs)) {
									...
									if (parseInt(bu) < parseInt(bs)) {
										if ((bv.old == true && br.old == true)
												|| (bv.old == false && br.old == false)) {
											bq = true
										}
										break
									} else {
	...
	function i(a3, d) {
		...
		if (parseInt(a2.major) >= 3 && parseInt(a2.major) <= 7
				&& a3.substr(-1) !== "+") {
			return false
		}
	...
	function y(a7) {
		...
		if (ad.ie) {
			...
			for (var a2 = 0; a2 < d.length; a2++) {
				if (aY(a7, d[a2])) {
					try {
						var a4 = new ActiveXObject("JavaWebStart.isInstalled."
								+ d[a2] + ".0");
						return "ok"
					} catch (w) {
					}
	...
	function g(a2, a8) {
		...
		var a3 = "ok", bb = "ok", ba = false, a5 = false, a6 = false, w, d;
	...
	function ar(d) {
		...
		return "https://java.com/dt-redirect?"
				+ ((u(window.location) && u(window.location.href)) ? ("&returnPage=" + window.location.href)
						: "") + (u(d) ? ("&locale=" + d) : "")
	}
	function V(d) {
	...
	function at(d) {
		if (d != null) {
			...
			return (a2 == "none" || w == "none" || a2 == "old" || w == "old")
					&& (w != "disabled" && a2 != "disabled")
		}
		return false
	}
	...
	function aF(w, a5, a4, a8, a6, a7) {
		...
		if (w.width < 250 || w.height < 160) {
			d.appendChild(aa.createElement("p").appendChild(
					aa.createTextNode(a5)));
	...
	function o(a3, w, a4, a7, a8, a9) {
		...
		var a5 = u(ba)
				&& (ba.javafxStatus() == "old" || ba.jreStatus() == "old");
		if (u(a3.placeholder)) {
			if (ax(w)) {
	...
	function a0(a5) {
		if (a5.placeholder != null) {
			var a3 = a5.width, a7 = a5.height;
			var a6 = !(a3 < 100 && a7 < 100);
			var a2 = a6 ? "javafx-loading-100x100.gif"
	...
	function aj(a4, a2, d, w) {
		if (a4 != null) {
			var a3 = null;
			if (d) {
				a3 = (a2 == "JavaFX") ? "install:inprogress:javafx"
						: "install:inprogress:jre"
			} else {
				a3 = (a2 == "JavaFX") ? "install:inprogress:javafx:manual"
	...
	var aq = {
		...
		"launch:fx:generic:embedded" : [
				...
				"https://java.com/javafx", "java.com/javafx",
				" for troubleshooting information." ],
		"install:fx:restart" : [
		...
		"install:inprogress:javafx:manual" : [
				...
				" then return to this page." ],
		"install:inprogress:jre:manual" : [
				"Please download and run Java Setup from ", "a", ar(),
		...
		"jre:plugin" : [ "b",
				...
				"Make sure that ", "a", "https://java.com",
		...
		"jre:unsupported" : [
				...
				"br", "Please consult ", "a", "https://java.com",
		...
		"javafx:unsupported" : [
				...
				"br", "Please consult ", "a", ah, "the JavaFX documentation",
		...
		"javafx:old" : [
				...
				"a", ah, "java.com/javafx", "." ],
		"javafx:none" : [ "b", "JavaFX 2.0 is required to view this content.",
				"br", "a", ah, "Get the JavaFX runtime from java.com/javafx",
	...
	function M(a3, w, a4) {
		...
		if ((typeof a7.placeholder == "string")) {
			...
			if (a5 == null) {
				throw "Application placeholder [id=" + a7.placeholder
						+ "] not found."
			}
			a7.placeholder = a5
		}
		...
		App : function(d, w) {
			...
			this.toString = function() {
				...
				return "dtjava.App: [url="
						...
						+ this.toolkit
						+ ", embedded_jnlp="
						+ (u(this.jnlp_content) ? (this.jnlp_content.length + " bytes")
								: "NO") + ", params=" + a2 + "]"
			}
		},
