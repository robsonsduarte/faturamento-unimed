                    ...
                    <svg width="100%" height="100%" viewBox="0 0 565 317" preserveAspectRatio="xMidYMid slice">
                      <defs>
                        <mask id="face-mask">
                          ...
                          <ellipse cx="282" cy="148" rx="95" ry="125" fill="black" />
                        </mask>
                      </defs>
                      <rect width="565" height="317" fill="rgba(0,0,0,0.25)" mask="url(#face-mask)" />
                      <ellipse cx="282" cy="148" rx="95" ry="125" fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="2" />
                    </svg>
